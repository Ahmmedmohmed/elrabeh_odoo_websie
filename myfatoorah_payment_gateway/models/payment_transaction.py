...
class PaymentTransaction(models.Model):
    ...
    def send_payment(self):
        ...
        try:
            ...
            raise ValidationError("MyFatoorah returned a non-JSON response:\n" + response.text)
        ...
        if not response_data.get('IsSuccess'):
            ...
            if validation_errors:
                ...
                raise ValidationError("Unknown error from MyFatoorah: " + response.text)

        if response_data.get('Data') and response_data['Data'].get('InvoiceURL'):
            payment_url = response_data['Data']['InvoiceURL']
